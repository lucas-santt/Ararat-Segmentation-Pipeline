...
-   **/src/**: Código fonte
    -   **/src/classes**: Contém a lógica principal do pipeline de extração de features.
        -   [`segmentation.py`](./src/classes/segmentation.py): Responsável por segmentar os ROIS das imagens
        -   [`pipeline.py`](./src/classes/pipeline.py): Responsável por extrair as features do(s) paciente(s)
    -   [`main.py`](./src/main.py): Ponto de entrada para a extração de features (Fase 1).
...
-   [`requirements.txt`](./requirements.txt): Lista de todas as dependências Python do projeto.
